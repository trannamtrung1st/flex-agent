...
COPY src/Modules/Evaluation/FlexAgent.Evaluation.Infrastructure/ src/Modules/Evaluation/FlexAgent.Evaluation.Infrastructure/
...
COPY contracts/schemas/v1/evaluation/evaluation-model-response.v1.schema.json contracts/schemas/v1/evaluation/evaluation-model-response.v1.schema.json
