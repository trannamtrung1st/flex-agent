...
-- Static queued/running Review fixtures (no Worker; in-flight evaluation_requests only).
INSERT INTO submissions_submissions (
    organization_id, submission_id, activity_id, cohort_id, baseline_id,
    enrollment_id, participant_actor_id, task_source_id, task_version_id,
    task_content_digest, created_at)
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2200000-0000-4000-8000-000000000006',
     'a1000000-0000-4000-8000-000000000025', 'c1000000-0000-4000-8000-000000000025',
     'd1000000-0000-4000-8000-000000000025', 'e1000000-0000-4000-8000-000000000003',
     'f1000000-0000-4000-8000-000000000002', '22222222-2222-2222-2222-222222222209',
     '33333333-3333-3333-3333-333333333309', repeat('j', 64), CLOCK_TIMESTAMP()),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2300000-0000-4000-8000-000000000006',
     'a1000000-0000-4000-8000-000000000025', 'c1000000-0000-4000-8000-000000000025',
     'd1000000-0000-4000-8000-000000000025', 'e1000000-0000-4000-8000-000000000004',
     'f1000000-0000-4000-8000-000000000003', '22222222-2222-2222-2222-222222222209',
     '33333333-3333-3333-3333-333333333309', repeat('j', 64), CLOCK_TIMESTAMP())
ON CONFLICT DO NOTHING;
...
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2200000-0000-4000-8000-000000000006',
     'f2200000-0000-4000-8000-000000000007', 1, 'a1000000-0000-4000-8000-000000000025',
     'c1000000-0000-4000-8000-000000000025', 'd1000000-0000-4000-8000-000000000025',
     'e1000000-0000-4000-8000-000000000003', 'f1000000-0000-4000-8000-000000000002',
     '22222222-2222-2222-2222-222222222209', '33333333-3333-3333-3333-333333333309',
     repeat('j', 64), repeat('e', 64), NULL, CLOCK_TIMESTAMP(),
     'f1000000-0000-4000-8000-000000000002'),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2300000-0000-4000-8000-000000000006',
     'f2300000-0000-4000-8000-000000000007', 1, 'a1000000-0000-4000-8000-000000000025',
     'c1000000-0000-4000-8000-000000000025', 'd1000000-0000-4000-8000-000000000025',
     'e1000000-0000-4000-8000-000000000004', 'f1000000-0000-4000-8000-000000000003',
     '22222222-2222-2222-2222-222222222209', '33333333-3333-3333-3333-333333333309',
     repeat('j', 64), repeat('e', 64), NULL, CLOCK_TIMESTAMP(),
...
INSERT INTO submissions_attempts (
    ...
    configuration_digest, manifest_digest)
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2200000-0000-4000-8000-000000000001',
     'a1000000-0000-4000-8000-000000000025', 'c1000000-0000-4000-8000-000000000025',
     'd1000000-0000-4000-8000-000000000025', 'e1000000-0000-4000-8000-000000000003',
     'f1000000-0000-4000-8000-000000000002', 'f1000000-0000-4000-8000-000000000001',
     1, 'baseline', NULL, 'completed', TRUE,
     CLOCK_TIMESTAMP(), CLOCK_TIMESTAMP(), CLOCK_TIMESTAMP(), 'completed',
     'f2200000-0000-4000-8000-000000000002', 'f2100000-0000-4000-8000-000000000003',
     'f2100000-0000-4000-8000-000000000004',
     'e5f9898c1fdfa4b20a792818ddb34ea20b2756e980c6bd48160dcede3be05b89',
     '5d3e95b981c053f6104ead70a95e67c76c727a2f3ad02fe4b8b65fe4518e5ef9'),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2300000-0000-4000-8000-000000000001',
     'a1000000-0000-4000-8000-000000000025', 'c1000000-0000-4000-8000-000000000025',
     'd1000000-0000-4000-8000-000000000025', 'e1000000-0000-4000-8000-000000000004',
     'f1000000-0000-4000-8000-000000000003', 'f1000000-0000-4000-8000-000000000001',
     1, 'baseline', NULL, 'completed', TRUE,
     CLOCK_TIMESTAMP(), CLOCK_TIMESTAMP(), CLOCK_TIMESTAMP(), 'completed',
     'f2300000-0000-4000-8000-000000000002', 'f2100000-0000-4000-8000-000000000003',
     'f2100000-0000-4000-8000-000000000004',
     'e5f9898c1fdfa4b20a792818ddb34ea20b2756e980c6bd48160dcede3be05b89',
     '5d3e95b981c053f6104ead70a95e67c76c727a2f3ad02fe4b8b65fe4518e5ef9')
ON CONFLICT DO NOTHING;
...
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2200000-0000-4000-8000-000000000001',
     'f2200000-0000-4000-8000-000000000007', 1, 1, repeat('e', 64)),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2300000-0000-4000-8000-000000000001',
     'f2300000-0000-4000-8000-000000000007', 1, 1, repeat('e', 64))
ON CONFLICT DO NOTHING;
...
INSERT INTO session_runtimes (
    ...
    session_version, session_sequence, cutoff_sequence)
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'a1000000-0000-4000-8000-000000000025',
     'f1000000-0000-4000-8000-000000000002', 'f2200000-0000-4000-8000-000000000001',
     'f2200000-0000-4000-8000-000000000002', 'f2100000-0000-4000-8000-000000000003',
     'e5f9898c1fdfa4b20a792818ddb34ea20b2756e980c6bd48160dcede3be05b89',
     'f2100000-0000-4000-8000-000000000004', 'completed', 1, 43, 43),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'a1000000-0000-4000-8000-000000000025',
     'f1000000-0000-4000-8000-000000000003', 'f2300000-0000-4000-8000-000000000001',
     'f2300000-0000-4000-8000-000000000002', 'f2100000-0000-4000-8000-000000000003',
     'e5f9898c1fdfa4b20a792818ddb34ea20b2756e980c6bd48160dcede3be05b89',
     'f2100000-0000-4000-8000-000000000004', 'completed', 1, 44, 44)
ON CONFLICT DO NOTHING;
...
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'a1000000-0000-4000-8000-000000000025',
     'f1000000-0000-4000-8000-000000000002', 'f2200000-0000-4000-8000-000000000001',
     'f2200000-0000-4000-8000-000000000002', 'mdl.p0.text.synthetic',
     'mdl.p0.text.synthetic.v1', repeat('a', 64), 'provider.synthetic',
     'organization_byok', 'cred.bind.synthetic', 'cred.bind.synthetic.v1'),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'a1000000-0000-4000-8000-000000000025',
     'f1000000-0000-4000-8000-000000000003', 'f2300000-0000-4000-8000-000000000001',
     'f2300000-0000-4000-8000-000000000002', 'mdl.p0.text.synthetic',
     'mdl.p0.text.synthetic.v1', repeat('a', 64), 'provider.synthetic',
     'organization_byok', 'cred.bind.synthetic', 'cred.bind.synthetic.v1')
ON CONFLICT DO NOTHING;
...
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'a1000000-0000-4000-8000-000000000025',
     'f1000000-0000-4000-8000-000000000002', 'f2200000-0000-4000-8000-000000000001',
     'f2200000-0000-4000-8000-000000000002', 'f2200000-0000-4000-8000-000000000005',
     'completed', 43, 'completed', 'completed', 'manifest-jcs-sha256-v2', repeat('f', 64)),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'a1000000-0000-4000-8000-000000000025',
     'f1000000-0000-4000-8000-000000000003', 'f2300000-0000-4000-8000-000000000001',
     'f2300000-0000-4000-8000-000000000002', 'f2300000-0000-4000-8000-000000000005',
     'completed', 44, 'completed', 'completed', 'manifest-jcs-sha256-v2', repeat('f', 64))
ON CONFLICT DO NOTHING;
...
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'a1000000-0000-4000-8000-000000000025',
     'f1000000-0000-4000-8000-000000000002', 'f2200000-0000-4000-8000-000000000001',
     'f2200000-0000-4000-8000-000000000002', 'handoff.demo-review.queued',
     'f2200000-0000-4000-8000-000000000005', 'manifest-jcs-sha256-v2', 'eligible',
     'completed', 43, 'f2100000-0000-4000-8000-000000000003',
     'e5f9898c1fdfa4b20a792818ddb34ea20b2756e980c6bd48160dcede3be05b89',
     'f2100000-0000-4000-8000-000000000004', repeat('f', 64)),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'a1000000-0000-4000-8000-000000000025',
     'f1000000-0000-4000-8000-000000000003', 'f2300000-0000-4000-8000-000000000001',
     'f2300000-0000-4000-8000-000000000002', 'handoff.demo-review.running',
     'f2300000-0000-4000-8000-000000000005', 'manifest-jcs-sha256-v2', 'eligible',
     'completed', 44, 'f2100000-0000-4000-8000-000000000003',
     'e5f9898c1fdfa4b20a792818ddb34ea20b2756e980c6bd48160dcede3be05b89',
     'f2100000-0000-4000-8000-000000000004', repeat('f', 64))
ON CONFLICT DO NOTHING;
...
INSERT INTO service_delegations (
    ...
    effective_at, expires_at, revoked_at, delegation_version)
VALUES
    ('f2200000-0000-4000-8000-000000000008', 'cccccccc-cccc-4ccc-8ccc-cccccccccccc',
     'a1000000-0000-4000-8000-000000000025', 'f1000000-0000-4000-8000-000000000002',
     'f2200000-0000-4000-8000-000000000001', 'f2200000-0000-4000-8000-000000000002',
     'f2100000-0000-4000-8000-00000000000d', 'evaluation.execute',
     'evaluation.execution', 'synthetic.demo-review.queued',
     CLOCK_TIMESTAMP() - INTERVAL '1 hour', CLOCK_TIMESTAMP() + INTERVAL '12 hours', NULL, 1),
    ('f2300000-0000-4000-8000-000000000008', 'cccccccc-cccc-4ccc-8ccc-cccccccccccc',
     'a1000000-0000-4000-8000-000000000025', 'f1000000-0000-4000-8000-000000000003',
     'f2300000-0000-4000-8000-000000000001', 'f2300000-0000-4000-8000-000000000002',
     'f2100000-0000-4000-8000-00000000000d', 'evaluation.execute',
     'evaluation.execution', 'synthetic.demo-review.running',
     CLOCK_TIMESTAMP() - INTERVAL '1 hour', CLOCK_TIMESTAMP() + INTERVAL '12 hours', NULL, 1)
ON CONFLICT DO NOTHING;
...
INSERT INTO evaluation_requests (
    ...
    evaluator_registry_version, lifecycle_policy_ref, correlation_id, completed_at)
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2200000-0000-4000-8000-000000000009',
     'a1000000-0000-4000-8000-000000000025', 'f1000000-0000-4000-8000-000000000002',
     'f2200000-0000-4000-8000-000000000001', 'f2200000-0000-4000-8000-000000000002',
     'handoff.demo-review.queued', 'f2200000-0000-4000-8000-000000000005', 'eligible',
     'completed', 43, 'initial', repeat('2', 64), 'idem.demo-review.queued',
     'f2200000-0000-4000-8000-000000000008', 'queued', NULL, NULL,
     '22222222-2222-2222-2222-222222222206', '33333333-3333-3333-3333-333333333316',
     'cb9db3a1cf6f96961cf8506ec3196edd2b9ce3d0dcf7cbfc4334ecaf624860de',
     'f2200000-0000-4000-8000-000000000006', 'f2200000-0000-4000-8000-000000000007',
     repeat('e', 64), 'f2100000-0000-4000-8000-000000000003',
     'f2100000-0000-4000-8000-000000000003',
     'e5f9898c1fdfa4b20a792818ddb34ea20b2756e980c6bd48160dcede3be05b89',
     'f2100000-0000-4000-8000-000000000004', 'f2100000-0000-4000-8000-000000000004',
     '5d3e95b981c053f6104ead70a95e67c76c727a2f3ad02fe4b8b65fe4518e5ef9',
     'manifest-jcs-sha256-v2', repeat('f', 64), 'mdl.p0.text.synthetic',
     'mdl.p0.text.synthetic.v1', repeat('a', 64), 'provider.synthetic',
     'organization_byok', 'cred.bind.synthetic', 'cred.bind.synthetic.v1',
     'evalreg.p0.v1', 'lifecycle.activity-closure-365d.v1',
     'f2200000-0000-4000-8000-000000000009', NULL),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2300000-0000-4000-8000-000000000009',
     'a1000000-0000-4000-8000-000000000025', 'f1000000-0000-4000-8000-000000000003',
     'f2300000-0000-4000-8000-000000000001', 'f2300000-0000-4000-8000-000000000002',
     'handoff.demo-review.running', 'f2300000-0000-4000-8000-000000000005', 'eligible',
     'completed', 44, 'initial', repeat('3', 64), 'idem.demo-review.running',
     'f2300000-0000-4000-8000-000000000008', 'running', NULL, NULL,
     '22222222-2222-2222-2222-222222222206', '33333333-3333-3333-3333-333333333316',
     'cb9db3a1cf6f96961cf8506ec3196edd2b9ce3d0dcf7cbfc4334ecaf624860de',
     'f2300000-0000-4000-8000-000000000006', 'f2300000-0000-4000-8000-000000000007',
     repeat('e', 64), 'f2100000-0000-4000-8000-000000000003',
     'f2100000-0000-4000-8000-000000000003',
     'e5f9898c1fdfa4b20a792818ddb34ea20b2756e980c6bd48160dcede3be05b89',
     'f2100000-0000-4000-8000-000000000004', 'f2100000-0000-4000-8000-000000000004',
     ...
     'organization_byok', 'cred.bind.synthetic', 'cred.bind.synthetic.v1',
     'evalreg.p0.v1', 'lifecycle.activity-closure-365d.v1',
     'f2300000-0000-4000-8000-000000000009', NULL)
ON CONFLICT DO NOTHING;
...
INSERT INTO review_cases (
    ...
    current_candidate_evaluation_id, created_at, updated_at)
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2200000-0000-4000-8000-00000000000e',
     'a1000000-0000-4000-8000-000000000025', 'f1000000-0000-4000-8000-000000000002',
     'f2200000-0000-4000-8000-000000000001', 'f2200000-0000-4000-8000-000000000002',
     'evaluation_available', 'none', NULL,
     CLOCK_TIMESTAMP() - INTERVAL '20 minutes', CLOCK_TIMESTAMP() - INTERVAL '5 minutes'),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2300000-0000-4000-8000-00000000000e',
     'a1000000-0000-4000-8000-000000000025', 'f1000000-0000-4000-8000-000000000003',
     'f2300000-0000-4000-8000-000000000001', 'f2300000-0000-4000-8000-000000000002',
     'evaluation_available', 'none', NULL,
...
INSERT INTO review_case_assignments (
    ...
    assignment_state, content_capability, assigned_at, revoked_at)
VALUES
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2200000-0000-4000-8000-00000000000f',
     'f2200000-0000-4000-8000-00000000000e', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaafb',
     'assigned', 'review.content.read', CLOCK_TIMESTAMP(), NULL),
    ('cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'f2300000-0000-4000-8000-00000000000f',
     'f2300000-0000-4000-8000-00000000000e', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaafb',
     'assigned', 'review.content.read', CLOCK_TIMESTAMP(), NULL)
ON CONFLICT DO NOTHING;
