...
export const PRODUCTION_ROUTE_LAYOUTS = {
  ...
  "/sessions/:sessionId/operations": "management",
  "/sessions/:sessionId/transcript": "management",
  "/review": "management",
  "/review/:reviewId": "guided-task",
  "/review/:reviewId/criteria/:criterionId": "guided-task",
  "/review/:reviewId/criteria/:criterionId/evidence/:evidenceId": "guided-task",
  "/release": "management",
