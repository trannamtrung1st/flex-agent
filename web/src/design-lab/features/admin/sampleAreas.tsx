import { PlateFoot, ReadoutGrid, ReadoutGridField, ReadoutGridRow, FrozenLine, InPlateHost } from "../../components";
  ...
  return (
    ...
    >
      ...
      <PlateFoot arrangement="start">
        <FrozenLine>Policy authoring is not seated in this prototype</FrozenLine>
      </PlateFoot>
      </InPlateHost>
    </SampleArea>
  );
