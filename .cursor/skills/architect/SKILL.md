...
- Ground decisions in approved specifications, `docs/product/concept-model.md`, `docs/product/mvp-scope.md`, current architecture documents, and current implementation evidence.
