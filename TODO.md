- [x] Maybe side menu console full height => TBD
...
- [x] Scan plain html, class, css convert to component. (Closed: page-authored Shipboard class grammar; not 1:1 wrappers for decorative CSS.)
