...
| Before frontend implementation | Apply the approved [Activity/Campaign journey](../ui-ux/activity-campaign-journey.md), [assessment Campaign setup interaction specification](../ui-ux/assessment-campaign-setup.md), and [Submission and Attempt interaction specification](../ui-ux/submission-attempt.md); author approved interaction specifications for Session, Evaluation/review, and Result/Release states. | The platform IA, P0 journey, setup interaction specification, and Submission/Attempt interaction specification are approved; three surface interaction specifications remain the UI/UX documentation gap. `AR-DEC-12` defines authority, not visual interaction. |
