...
Approved — 2026-08-26; amended 2026-08-26 to require protected-subtree remount on identity replacement, fresh permission observation before dependent reads, exact no-refetch Activities invalidation, an authorization-context epoch on every successful trusted-context replacement, and to keep synthetic command follow-up refresh distinct from that replacement.
