...
| UI/UX | Journey and first four surface specifications approved | The platform-level [Flex Agent activity journey and MVP campaign information architecture](ui-ux/activity-campaign-journey.md), [assessment Campaign setup interaction specification](ui-ux/assessment-campaign-setup.md), [Submission and Attempt interaction specification](ui-ux/submission-attempt.md), [Text Session interaction specification](ui-ux/text-session.md), and [Evidence, Evaluation, and Human Review interaction specification](ui-ux/evidence-evaluation-human-review.md) are `Approved`; the Result/Release surface specification and design-system guidance remain to be authored |
...
- [UI/UX documentation](ui-ux/README.md) — Approved platform Activity IA, end-to-end P0 assessment Campaign journey, approved assessment Campaign setup, Submission/Attempt, Text Session, and Evidence/Evaluation/Human Review interaction specifications, plus the remaining interaction/accessibility/design-system catalog
