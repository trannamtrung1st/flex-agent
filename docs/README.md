...
- [Provider deployment profiles](operations/provider-profiles/README.md) — non-secret Direct OpenAI example, approved OpenRouter synthetic-development profile, Keycloak OIDC contract profile, and fail-closed qualification boundaries
