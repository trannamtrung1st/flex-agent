...
| Requirements | P0 specification review in progress | [Feature catalog](requirements/README.md#feature-catalog-overview); P0 #1–#5 `Approved` and P0 #6–#7 placeholders |
...
| Feature specifications | Catalog complete; P0 #1–#5 approved | 19 specs (7 P0, 2 P1, 5 P2, 5 P3); see [features/](requirements/features/README.md) |
...
- [Feature specifications](requirements/features/README.md) — 19 specs; P0 #1–#5 approved, author placeholder P0 #6 next
