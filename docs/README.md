...
| UI/UX | Journey and all five P0 surface specifications approved; shared design system in review | The platform-level [Flex Agent activity journey and MVP campaign information architecture](ui-ux/activity-campaign-journey.md), [assessment Campaign setup interaction specification](ui-ux/assessment-campaign-setup.md), [Submission and Attempt interaction specification](ui-ux/submission-attempt.md), [Text Session interaction specification](ui-ux/text-session.md), [Evidence, Evaluation, and Human Review interaction specification](ui-ux/evidence-evaluation-human-review.md), and [Result and Release interaction specification](ui-ux/result-release.md) are `Approved`; the shared [design system](ui-ux/design-system/README.md) is `In review v0.1` |
...
- [UI/UX documentation](ui-ux/README.md) — Approved platform Activity IA, end-to-end P0 assessment Campaign journey, all five approved P0 surface interaction specifications, and the in-review shared design system
