...
| UI/UX | Journey and first three surface specifications approved | The platform-level [Flex Agent activity journey and MVP campaign information architecture](ui-ux/activity-campaign-journey.md), [assessment Campaign setup interaction specification](ui-ux/assessment-campaign-setup.md), [Submission and Attempt interaction specification](ui-ux/submission-attempt.md), and [Text Session interaction specification](ui-ux/text-session.md) are `Approved`; two P0 surface specifications and design-system guidance remain to be authored |
...
- [UI/UX documentation](ui-ux/README.md) — Approved platform Activity IA, end-to-end P0 assessment Campaign journey, approved assessment Campaign setup, Submission/Attempt, and Text Session interaction specifications, and the remaining interaction/accessibility/design-system catalog
