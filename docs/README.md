...
| UI/UX | Journey approved | The platform-level [Flex Agent activity journey and MVP campaign information architecture](ui-ux/activity-campaign-journey.md) is `Approved`; P0 surface interaction specifications and design-system guidance remain to be authored |
...
- [UI/UX documentation](ui-ux/README.md) — Approved platform Activity IA and end-to-end P0 assessment Campaign journey plus the catalog for pending interaction specifications, accessibility, content, and design-system guidance
