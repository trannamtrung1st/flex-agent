...
**P0 specification review in progress.** Product baseline v0.1 is approved. Nineteen feature-spec files exist under [`features/`](features/README.md). P0 #1 [`auth-resource-isolation.md`](features/auth-resource-isolation.md), P0 #2 [`resolved-session-configuration.md`](features/resolved-session-configuration.md), P0 #3 [`assessment-setup.md`](features/assessment-setup.md), and P0 #4 [`submission-attempts.md`](features/submission-attempts.md) are `Approved`; P0 #5–#7 and all twelve P1–P3 files remain placeholders. Author P0 #5 before implementation.
