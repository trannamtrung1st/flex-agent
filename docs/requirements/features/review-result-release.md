...
- Related decisions: Approved defaults `PROP-1`–`PROP-10` in this specification. [ADR-001](../../architecture/session-runtime-contract.md) governs resolved-configuration and manifest integrity. [ADR-002](../../architecture/backend-module-architecture.md) governs human and service authorization. [ADR-003](../../architecture/backend-module-architecture.md) governs durable audit. [ADR-004](../../architecture/mvp-architecture.md) governs the frozen cohort baseline. [ADR-005](../../architecture/session-runtime-contract.md) governs the exact Attempt, Session, and Submission binding. [ADR-006](../../architecture/mvp-architecture.md) governs the lifecycle resolver direction, atomic Release/Result/participant-visibility boundary, and asynchronous-notification separation. [ADR-009](../../architecture/mvp-architecture.md) approves the detailed [Human review, Result, and Release contract](../../architecture/review-result-release-contract.md), including exact candidate selection, decision/Result atomicity, Release visibility, correction, and availability-only MVP notifications. The [MVP operational defaults](../mvp-operational-defaults.md#protected-data-lifecycle-defaults) govern default outcome-record retention.
...
- Approved [Human review, Result, and Release contract](../../architecture/review-result-release-contract.md) and [ADR-009](../../architecture/mvp-architecture.md) for candidate/decision/Result records, lifecycle enforcement, concurrency/idempotency, atomic Release/visibility/audit, correction, and MVP notifications.
- Approved [Evidence, Evaluation, and Human Review interaction specification](../../ui-ux/flows/evidence-evaluation-human-review.md) for review queues, criterion/Evidence inspection, Human revision, Review decision, pre-decision preview, conflict, and Reviewer accessibility states, plus the approved [Result and Release interaction specification](../../ui-ux/flows/result-release.md) for Release confirmation, Participant Result, correction, and their accessibility states.
