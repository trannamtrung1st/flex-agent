...
| UX requirements, `AC-REL-10`–`AC-REL-12`, `PROP-9` | Review-side behavior is approved in the [Evidence, Evaluation, and Human Review interaction specification](../../ui-ux/evidence-evaluation-human-review.md), and Release/Participant behavior is approved in the [Result and Release interaction specification](../../ui-ux/result-release.md); frontend implementation remains TBD | Component accessibility and end-to-end keyboard/screen-reader tests TBD | Required Playwright accessibility snapshots and desktop/narrow screenshots across applicable states | Gap |
