...
| --- | --- | --- |
| `REQ-AUTH-1`, `REQ-AUTH-2`, `AC-AUTH-1`, `AC-AUTH-13` | Identity-resolution, Organization-context, cookie/OIDC contract, back-channel scope, JWKS, PostgreSQL persistence, SSE application-session tests, and required `pnpm verify:oidc` | Canonical `web-legacy` gateway journey plus named candidate/non-Production Wave 8.1 shell; synthetic `/browser` is not authentication evidence |
| `REQ-AUTH-3`–`REQ-AUTH-6`, `AC-AUTH-4`, `AC-AUTH-5`, `AC-AUTH-10` | Cross-organization matrix; upper/lower-scope conflict tests | Administrator scope and denial flows |
| `REQ-AUTH-7`, `REQ-AUTH-8`, `REQ-AUTH-24`, `AC-AUTH-2`, `AC-AUTH-3`, `AC-AUTH-19` | Cross-participant and concurrent-session integration tests | Participant own-session and denied-resource journeys |
| `REQ-AUTH-9`, `REQ-AUTH-10`, `AC-AUTH-5`, `AC-AUTH-6` | Active, expired, revoked, and unrelated assignment tests | Reviewer assigned/unassigned states |
| `REQ-AUTH-11`, `REQ-AUTH-15`, `AC-AUTH-16` | Job/event scope tampering, workload-authentication, binding, cross-scope, stale-delegation, claim/revoke, and disclosure-admission tests | Operational evidence only |
| `REQ-AUTH-12`–`REQ-AUTH-14`, `AC-AUTH-7`, `AC-AUTH-8` | List/count leakage; parent mismatch; download/export tests; Worker host composition | Scoped tables, search, empty states, and denied downloads |
| `REQ-AUTH-16`, `REQ-AUTH-17`, `AC-AUTH-9` | Forged organization/owner field contract tests | Validation and denial messages |
| `REQ-AUTH-18`–`REQ-AUTH-20`, `AC-AUTH-11`, `AC-AUTH-12`, `AC-AUTH-17` | Concurrency, cache invalidation, timeout, retry, and batch tests | Permission-changed and access-expired states |
| `REQ-AUTH-21`, `REQ-AUTH-22`, `AC-AUTH-3`, `AC-AUTH-13` | Existence-oracle and no-side-effect tests | Generic unavailable states |
| `REQ-AUTH-23`, `AC-AUTH-18` | Released/unreleased participant-access tests | Participant result visibility states |
| `REQ-AUTH-25`, `AC-AUTH-4`, `AC-AUTH-7`, `AC-AUTH-8`, `AC-AUTH-16`, `AC-AUTH-19` | Cache-key, index, event, job, and concurrent-session isolation tests | Operational evidence; no direct UI requirement |
| `REQ-AUTH-26`–`REQ-AUTH-29`, `REQ-AUTH-31`, `REQ-AUTH-33`, `AC-AUTH-14`, `AC-AUTH-15`, `AC-AUTH-22`, `AC-AUTH-24` | Audit schema, append-only history, redaction, durability-class, buffer-failure, and lifecycle-policy tests | Audit-history and export evidence |
| `REQ-AUTH-32`, `AC-AUTH-23` | Completed-resource active/revoked relationship and released/unreleased visibility tests | Completed-session participant and reviewer access states |
| `REQ-AUTH-30`, `AC-AUTH-21` | Machine-readable Playwright case-ID manifest plus Keycloak compatibility and Compose negatives | Canonical and candidate Playwright reports under `artifacts/oidc/` |
| UX and accessibility requirements, `AC-AUTH-20` | Component accessibility tests where applicable | Keyboard, focus, narrow viewport, loading, and denial screenshots |
