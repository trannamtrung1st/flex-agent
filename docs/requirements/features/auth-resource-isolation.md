...
| UX and accessibility requirements, `AC-AUTH-20` | The approved [Activity/Campaign journey](../../ui-ux/activity-campaign-journey.md), [assessment Campaign setup](../../ui-ux/assessment-campaign-setup.md), [Submission and Attempt](../../ui-ux/submission-attempt.md), [Text Session](../../ui-ux/text-session.md), and [Evidence, Evaluation, and Human Review](../../ui-ux/evidence-evaluation-human-review.md) specifications define current P0 access-state patterns; Result/Release interaction specification and implementation remain TBD | Component accessibility tests where applicable | Keyboard, focus, narrow viewport, loading, and denial screenshots | Gap |
