...
| --- | --- | --- | --- | --- |
| `REQ-SUBM-1`–`REQ-SUBM-8`, `REQ-SUBM-43`, `AC-SUBM-1`–`AC-SUBM-4`, `AC-SUBM-29`, `PROP-6` | Enrollment model, activated-cohort binding, scoped commands, in-product discovery, and notification record — approved [ADR-002](../../architecture/decisions/ADR-002-authorization-enforcement-and-delegation.md), [ADR-004](../../architecture/decisions/ADR-004-assessment-activation-baseline-and-atomicity.md), and [MVP architecture](../../architecture/mvp-architecture.md); implementation and UI/UX specification TBD | Assignment, inactive cohort, cross-scope, duplicate/concurrent command, suspension/revocation, scoped discovery tests | Empty/active/suspended/revoked assignment, conflict, and participant discovery states | Gap |
...
| Performance/reliability requirements, `AC-SUBM-9`, `AC-SUBM-17`, `AC-SUBM-27`, `PROP-5` | Backpressure, idempotency, consistency boundary, reconciliation, and SLO telemetry — approved [MVP architecture](../../architecture/mvp-architecture.md), [ADR-005](../../architecture/decisions/ADR-005-atomic-attempt-start-and-submission-binding.md), and [ADR-010](../../architecture/decisions/ADR-010-dotnet-implementation-stack-and-workspace.md); implementation TBD | Load, concurrency, timeout, cancellation, dependency failure, cleanup/reconciliation tests | Progress, cancel, retry, delayed validation, uncertain outcome, recovery states | Gap |
