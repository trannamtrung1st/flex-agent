...
| `REQ-SUBM-9`–`REQ-SUBM-14`, `REQ-SUBM-50`–`REQ-SUBM-56`, `AC-SUBM-11`, `AC-SUBM-12`, `AC-SUBM-22`, `AC-SUBM-33`–`AC-SUBM-39`, `PROP-3`, `PROP-9`–`PROP-15` | Submissions timing/accommodation domain, `0046` persistence, parallel v2 Enrollment/**My work** projections, and SPA timing UI. Production positive grants remain fail-closed until Configuration supplies an exact current Organization policy; Assessment frozen policy snapshots are still adapter-defaulted when omitted. Attempt start, retry, and intake remain out of this slice. | Domain coordinators; PostgreSQL `0046` upgrade, isolation, concurrency, idempotency, session-revocation, audit-rollback, and append-only tests; contract catalog/OpenAPI/C#/TypeScript v2 fixtures; HTTP CSRF/unknown-member/unauthenticated timing negatives; Enrollment and **My work** vitest | Component timing/accommodation states exist. Authenticated Playwright MCP desktop/narrow/400%/theme evidence is not yet captured for this slice | Partial |
