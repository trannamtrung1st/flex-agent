...
- Last amended: 2026-08-23 — approved `PROP-8`, `REQ-SUBM-57`–`REQ-SUBM-58`,
  ...
  keeps a valid longer `0044` window instead of rewriting it to 10 seconds.
