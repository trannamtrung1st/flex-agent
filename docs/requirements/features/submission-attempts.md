...
| --- | --- | --- | --- | --- |
| `REQ-SUBM-1`–`REQ-SUBM-8`, `REQ-SUBM-43`, `AC-SUBM-1`–`AC-SUBM-4`, `AC-SUBM-29`, `PROP-6` | Enrollment model, activated-cohort binding, scoped commands, in-product discovery, and notification record — approved [ADR-002](../../architecture/decisions/ADR-002-authorization-enforcement-and-delegation.md), [ADR-004](../../architecture/decisions/ADR-004-assessment-activation-baseline-and-atomicity.md), [MVP architecture](../../architecture/mvp-architecture.md), and [Submission and Attempt interaction specification](../../ui-ux/submission-attempt.md); implementation TBD | Assignment, inactive cohort, cross-scope, duplicate/concurrent command, suspension/revocation, scoped discovery tests | Empty/active/suspended/revoked assignment, conflict, and participant discovery states | Gap |
