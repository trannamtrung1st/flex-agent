...
| --- | --- | --- | --- | --- |
| `REQ-ACT-1`–`REQ-ACT-8`, `AC-ACT-1`–`AC-ACT-5`, `AC-ACT-18` | Activity draft/revision model, scoped source selectors, and optimistic concurrency — approved [MVP architecture](../../architecture/mvp-architecture.md), [ADR-002](../../architecture/decisions/ADR-002-authorization-enforcement-and-delegation.md), and [assessment Campaign setup interaction specification](../../ui-ux/assessment-campaign-setup.md); implementation TBD | Draft lifecycle, required-field, cross-scope, widening, stale-revision, and history tests | Empty/populated draft, selector, validation, conflict, and save states | Gap |
...
| UX/accessibility requirements, `AC-ACT-22` | Approved [assessment Campaign setup interaction specification](../../ui-ux/assessment-campaign-setup.md); accessible component implementation TBD | Component accessibility and keyboard tests | Playwright desktop/narrow screenshots for all applicable states | Gap |
