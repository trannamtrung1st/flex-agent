...
| Downstream boundary, `REQ-EVAL-28`, `AC-EVAL-20`, `PROP-3`, `PROP-4` | `review-result-release.md` contract TBD | No-release side-effect, terminal-state routing and review-version selection integration tests | Completed versus unevaluated terminal case handoff | Gap |
