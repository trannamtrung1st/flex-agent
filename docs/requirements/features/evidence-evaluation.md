...
- Related decisions: Approved defaults `PROP-1`–`PROP-8` in this specification. [ADR-001](../../architecture/session-runtime-contract.md) governs resolved-configuration and manifest integrity. [ADR-002](../../architecture/backend-module-architecture.md) governs human and service authorization. [ADR-003](../../architecture/backend-module-architecture.md) governs durable audit. [ADR-005](../../architecture/session-runtime-contract.md) governs the exact Submission binding. [ADR-006](../../architecture/mvp-architecture.md) governs durable worker execution, provider-neutral model access, and the restricted deterministic-evaluator boundary. [ADR-009](../../architecture/mvp-architecture.md) approves the detailed [Evidence and Evaluation execution contract](../../architecture/evaluation-execution-contract.md), including locator/seal, evaluator, completion, and replacement-lineage realization. The [MVP operational defaults](../mvp-operational-defaults.md#protected-data-lifecycle-defaults) govern default Evidence and Evaluation retention.
...
- WCAG 2.2 AA and the detailed Reviewer interaction contract are approved in the [Evidence, Evaluation, and Human Review interaction specification](../../ui-ux/flows/evidence-evaluation-human-review.md). Implementation and Playwright evidence remain downstream traceability gaps; Release interactions are governed by the approved [Result and Release interaction specification](../../ui-ux/flows/result-release.md).
...
- Approved [Evidence and Evaluation execution contract](../../architecture/evaluation-execution-contract.md) and [ADR-009](../../architecture/mvp-architecture.md) for Evidence locators/sealing, completion consistency, evaluator isolation/provenance, provider trust, retries, and replacement lineage.
...
- Approved [Evidence, Evaluation, and Human Review interaction specification](../../ui-ux/flows/evidence-evaluation-human-review.md) for reviewer inspection.
...
- Apply the approved [Evidence, Evaluation, and Human Review interaction specification](../../ui-ux/flows/evidence-evaluation-human-review.md). Frontend implementation, automated accessibility checks, and Playwright evidence across desktop and narrow Reviewer states remain delivery gaps.
...
| --- | --- | --- |
| `REQ-EVAL-1`–`REQ-EVAL-7`, `AC-EVAL-1`–`AC-EVAL-5` | Eligible/ineligible handoff, mutable alias, stale input, duplicate/concurrent/conflicting request tests | Queued, running, existing, incomplete-handoff, conflict states |
| `REQ-EVAL-8`–`REQ-EVAL-17`, `AC-EVAL-5`–`AC-EVAL-8`, `PROP-2` | Exact Submission/transcript/config locators; post-cutoff, unbound, forged, cross-scope, integrity, precision tests | Criterion-to-source navigation, whole-artifact, invalid/unavailable citation states |
| `REQ-EVAL-18`–`REQ-EVAL-28`, `AC-EVAL-9`–`AC-EVAL-14`, `AC-EVAL-20`, `PROP-1`, `PROP-5` | Criterion completeness, insufficiency, applicability, ranges, aggregation, citation, rationale and prohibited-content tests | Structured criterion, uncertainty, insufficiency, provisional labeling evidence |
| `REQ-EVAL-47`–`REQ-EVAL-53`, `AC-EVAL-32`–`AC-EVAL-38`, `PROP-8` | Mode-freeze, reproducibility, exact-version, Agent-assisted, conflict, failure, injection, resource-limit, prohibited-code/network/external-call tests | Evaluator mode, deterministic fact, Agent interpretation, conflict and failure provenance states |
| `REQ-EVAL-29`–`REQ-EVAL-36`, `AC-EVAL-15`–`AC-EVAL-19`, `AC-EVAL-27`, `PROP-4` | Provider timeout/lost response, partial output, concurrent completion, retry exhaustion, replacement and source-unavailability tests | Failed, retrying, review-required, superseded, integrity-warning states |
| `REQ-EVAL-37`–`REQ-EVAL-46`, `AC-EVAL-21`–`AC-EVAL-27`, `AC-EVAL-30` | Full wrong-scope/assignment matrix, prompt injection, audit failure, log leakage, unauthorized export/reuse tests | Permission denied, redacted/minimized content, revoked assignment, source authorization states |
| UX requirements, `AC-EVAL-22`, `AC-EVAL-28` | Accessibility component and end-to-end tests TBD | Required Playwright accessibility snapshots and desktop/narrow screenshots |
| Performance requirements, `AC-EVAL-29`, `PROP-6` | Representative p95 status/completion, bounded input, outage, saturation and recovery tests | Pending, delayed, timeout and recovery messaging |
| `AC-EVAL-31`, `AC-EVAL-36` | Complete reconstruction, evaluator/model provenance, lawful unavailability, corrupted locator/manifest and lineage tests | Reviewer/auditor provenance view |
| Downstream boundary, `REQ-EVAL-28`, `AC-EVAL-20`, `PROP-3`, `PROP-4` | No-release side-effect, terminal-state routing and explicit review-version selection integration tests | Completed versus unevaluated terminal case handoff |
