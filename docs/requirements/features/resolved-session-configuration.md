...
| --- | --- | --- | --- | --- |
| `REQ-RSC-1`–`REQ-RSC-8`, `AC-RSC-1`–`AC-RSC-5` | Resolver boundary, precedence engine, trusted ownership chain, override validation — architecture TBD | Unit/property tests for precedence; cross-layer conflict matrix; unauthorized/authorized override tests | Administrator conflict and override states; reviewer provenance summary | Gap |
