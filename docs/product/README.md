...
3. Apply the approved [P0 Activity journey](../ui-ux/activity-campaign-journey.md), [assessment Campaign setup interaction specification](../ui-ux/assessment-campaign-setup.md), [Submission and Attempt interaction specification](../ui-ux/submission-attempt.md), and [Text Session interaction specification](../ui-ux/text-session.md); author the two remaining P0 surface interaction specifications before frontend implementation is considered complete
