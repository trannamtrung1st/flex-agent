> **In review (Phase 3 preparation).** This file is the distinct representative-journey owner under `docs/ui-ux/flows/`. Until Phase 4 cutover, the Approved v1.0 original at [`docs/ui-ux/result-release.md`](../result-release.md) remains current UI/UX governance. Do not merge this journey with another flow file.
...
- The [design-system foundation](../design-system/README.md) (Approved v1.0)
  ...
  Visual presentation follows Shipboard Terminal; this specification still
  governs Release authority, Participant disclosure, and states.
