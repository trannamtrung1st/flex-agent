> **In review (Phase 3 preparation).** This file is the distinct representative-journey owner under `docs/ui-ux/flows/`. Until Phase 4 cutover, the Approved v1.0 original at [`docs/ui-ux/evidence-evaluation-human-review.md`](../evidence-evaluation-human-review.md) remains current UI/UX governance. Do not merge this journey with another flow file.
