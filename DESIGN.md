...
Content fingerprint: `7af2d4a3ac5faf3fa5c44ec186f4aae9f482adb07b1e2358e3f2c4aafd2b73c7`

## Canonical sources

- `docs/ui-ux/design-system/README.md` — Approved v0.1 (version 0.1)
- `docs/ui-ux/design-system/implementation-guide.md`
- `docs/ui-ux/README.md`

## Projection

**Approved v0.1** is authoritative for shared visual language, semantic tokens, reusable component behavior, accessibility foundations, and recurring Flex Agent UI patterns. All modules under this directory inherit this metadata unless they declare narrower metadata.
