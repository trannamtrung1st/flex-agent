...
export function CohortsArea() {
  return (
    <SampleArea
      ...
      advisoryCopy="Cohort records are not loaded in this synthetic dataset. A Cohort is an administrative grouping, never a shared room."
...
export function UsersAccessArea() {
  return (
    <SampleArea
      ...
      advisoryLabel="Organization"
      advisoryCopy="Administrators and Reviewers are operator accounts. Participants remain Campaign Enrollments and are not managed on this plate."
...
export function PoliciesArea() {
  return (
    <SampleArea
      ...
      advisoryLabel="Governance"
      advisoryCopy="These are demonstration readouts of organization limits — not a preference sheet and not a policy-rule builder."
    >
...
export function AuditLogArea() {
  return (
    <SampleArea
      ...
      advisoryLabel="Read only"
      advisoryCopy="Audit-relevant history cannot be silently overwritten. This prototype does not fabricate production events."
