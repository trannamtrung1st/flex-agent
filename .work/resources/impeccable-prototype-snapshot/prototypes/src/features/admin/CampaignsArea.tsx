...
import { EMPTY_SELECTION, removeIds } from "../../components/tableSelection";
...
export function CampaignsArea() {
      ...
      >
        <div className="campaigns-unavailable">
          <EmptyPlate
            ...
            note={`Nothing in the registry answers ${campaignId}. Return to the registry and open a listed campaign.`}
          >
  ...
  const activate = (values: CampaignForm) => {
    ...
    announce(`Campaign ${campaign.id} activated. Configuration frozen for the whole cohort.`);
  };
