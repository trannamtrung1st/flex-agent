...
import { IndexRail } from "../../components/navigation";
    ...
    <>
      ...
      <div className="deck" onClick={onDeckClick}>
        ...
        <main className="deck-main">
          ...
          <p className="deck-note">Every interactive specimen below renders its production React module from <span className="code">src/components</span>, backed by the shared token and class contracts in <span className="code">src/styles/components</span>. Specimens marked amber are rationed on live surfaces: one hot key, one attention voice per region.</p>
          <FoundationsSections />
          <NavigationSections />
