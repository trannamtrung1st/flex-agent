...
phase6_slice2_wider_ac_eval24: corrective-pending-push
...
- [>] Red: prompt-injection and confused-deputy suites across Submission text,
  ...
  **Wider AC-EVAL-24 matrix (`[>]`):** `EvidenceSourceWiderMatrixPromptInjectionTests`
  ...
  test codified the gap. **Corrective pass (pending push):** require ordinal
  ...
  **Pending corrective push, fresh Implementation CI, and external re-review.**
