...
status: in-progress
created: 2026-09-07
updated: 2026-09-13T00:45:00+07:00
phase6_slice2_wider_ac_eval24: confirmed-661e1ef8
...
- [>] Red: prompt-injection and confused-deputy suites across Submission text,
  ...
  **Wider AC-EVAL-24 matrix (`[>]`):** `EvidenceSourceWiderMatrixPromptInjectionTests`
  ...
  `AC-EVAL-24`. **Pushed at `661e1ef8`.** Confirmation pass 2026-09-13:
  `EvidenceSourceWiderMatrixPromptInjectionTests` 11; combined AC-EVAL-24
  injection suites **28** (`EvidenceSourcePromptInjectionAndConfusedDeputyTests`
  9 + `EvaluationModelPromptInjectionAndConfusedDeputyTests` 8 + wider matrix
  11); Evaluation unit **354**; `verify-dotnet.sh` green (local at `661e1ef8`).
  Hosted Documentation `34707124487` green at `661e1ef8`; Implementation
  `34707124507` in progress at confirmation (authoritative when all six jobs
  green). **Pending external review; not approved.** **Slice 2 remainder:**
  wider AC-EVAL-24 matrix review/CI; credential fail-closed **closed** at
  `68b35ee7`.
- [>] Independently validate every model response for schema, exact criterion
  ...
  **Phase 6 slice 2 not closed** — wider AC-EVAL-24 matrix at `661e1ef8`
  (`EvidenceSourceWiderMatrixPromptInjectionTests` 11); confirmation pass green;
  hosted Implementation CI `34707124507` pending terminal; external review
  outstanding. Worker disabled.
...
- **Phase 6 slice 2 in progress.** Store/authority-binding increment **approved**
  ...
  **0/0/0/0**; Implementation CI `34706092150`. Focused:
  ...
  `68b35ee7`; external re-review **0/0/0/0**; Implementation CI `34706092150`).
  **Wider AC-EVAL-24 matrix:** `661e1ef8`
  `EvidenceSourceWiderMatrixPromptInjectionTests` 11; confirmation pass green;
  combined injection suites **28**; Evaluation unit **354**; Documentation CI
  `34707124487` green; Implementation CI `34707124507` pending terminal at
  confirmation. **Not approved; slice 2 not closed.** Worker disabled. **Do
...
| Phase 6 slice 2 wider AC-EVAL-24 matrix (`661e1ef8`) | pending | `EvidenceSourceWiderMatrixPromptInjectionTests` 11: text_attachment; filename authority invariant; agent fragment assembly; manifest.fact stripping; knowledge-shaped configuration; deterministic.fact locator/completion; metadata projector injected source_id negative. Model-output boundary covered by approved model-boundary suite. No production code change. Confirmation pass 2026-09-13: combined AC-EVAL-24 injection suites **28**; Evaluation unit **354**; `verify-dotnet.sh` green (local). Authoritative head `661e1ef8`; Documentation `34707124487` green; Implementation `34707124507` in progress at confirmation. **Pending terminal CI and external review; not approved.** Worker disabled |
